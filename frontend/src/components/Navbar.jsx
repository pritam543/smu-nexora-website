...
const Navbar = () => {
  return (
    <nav className="bg-slate-900/90 backdrop-blur-md border-b border-slate-800 text-white px-6 py-4 flex justify-between items-center sticky top-0 z-50">
      ...
      <button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-6 py-2 rounded-full font-medium text-sm transition-all shadow-md shadow-blue-600/25 border border-blue-400/20">
        Get Started
      </button>
    </nav>
  );
